...
<body ng-app="eventApp" style="color: #000;">
  ...
  <div class ="title-eve"><br>
   ...
   <div class ="card"style ="padding:4px;background-image:url('../images/card.jpg')" ><br>
   <center><img src ={{h.url}} width="65%"height="200"style ="border-radius:10px;">
  ...
  <div class ="container-fluid top ">
    ...
    <div class ="col-2 sidebarmenu"><a href="#" class="c1 eve-icon20" name ="about" >
        <span><i class="fa fa-address-book-o" style="color:#413e66"></i></span></a></div>
    <div class ="col-2 sidebarmenu"><a href="#" class="c2 eve-icon20" name ="detail">
        <span><i class="fa fa-info" style="color:#413e66"></i></span></a></div>
    <div class ="col-2 sidebarmenu"><a href="#"  class="c3 eve-icon20"name ="prizes" >
        <span><i class="fa fa-trophy" style="color:#413e66"></i></span></a></div>
    <div class ="col-2 sidebarmenu"><a href="#" class="c4 eve-icon20" name ="rules" >
        <span><i class="fa fa-book" style="color:#413e66"></i></span></a></div>
    <div class ="col-2 sidebarmenu"><a href="#" class="c5 eve-icon20" name ="coordinators" >
        <span><i class="fa fa-users" style="color:#413e66"></i></span></a></div>
        </div>
        </div>
        <br>
        <div class="row">
